...
class CatalogueModel{
  static List<Item> items = [];  // items could not be empty so we added = []; empty backets to avoid null error.
  // = [
  //   Item(
  //       id: 1,
  //       name: "iPhone 12 Pro",
  ...
  // static final catModel = CatalogueModel._internal();   //singleton class
  //
